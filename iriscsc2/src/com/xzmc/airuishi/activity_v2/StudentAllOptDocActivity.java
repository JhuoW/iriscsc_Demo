...
import com.xzmc.airuishi.activity_v2.MyAllOptDocActivity.DocAdapter;
import com.xzmc.airuishi.activity_v2.MyAllOptDocActivity.DocAdapter.ViewHolder;
...
public class StudentAllOptDocActivity extends BaseActivity {
	ListView listview;
	...
	private void initView() {
		...
		headerLayout.showLeftBackButton(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				StudentAllOptDocActivity.this.finish();
			}
		});
